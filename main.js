...
function whoAmI() {
		const detail = {
			...
			customMessage : (document.querySelector('[data-o-ads-custom-message]')) ? document.querySelector('[data-o-ads-custom-message]').getAttribute('data-o-ads-custom-message') : false
		};
